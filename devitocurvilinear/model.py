...
class SeismicModel(GenericModel):
    ...
    qs : array_like or float
        S-wave attenuation.
    hxi : array_like or float
        Scale factor in axis-1 direction for curvilinear coordinates.
    heta : array_like or float
        Scale factor in axis-2 direction for curvilinear coordinates.
    hzi : array_like or float
        Scale factor in axis-3 direction for curvilinear coordinates.
    """
    _known_parameters = ['vp', 'damp', 'vs', 'b', 'epsilon', 'delta',
                         'theta', 'phi', 'qp', 'qs', 'lam', 'mu', 'hxi', 'heta', 'hzi']
